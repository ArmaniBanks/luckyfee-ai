  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-bags-muted mt-1">Cryptographically fair random draw. When enough participants have entered, trigger a draw to select a winner who can claim their reward.</p>
      </div>

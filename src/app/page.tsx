  ...
  return (
    <div className="space-y-8">
      <section className="text-center py-8">
        ...
        <p className="text-bags-muted max-w-xl mx-auto">Three reward pools running simultaneously. Pick your tier, enter with SOL, and win 98% of the pot every 5 minutes.</p>
      </section>
      <section className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard label="Total in Pools" value={`${formatSol(totalRewardPool)} SOL`} icon={Wallet} glow />
        <StatCard label="Participants" value={totalParticipants.toString()} icon={Users} subtitle="across all pools" />
      ...
      <section className="grid lg:grid-cols-5 gap-6">
        <div className="lg:col-span-3"><PoolEntry /></div>
        <div className="lg:col-span-2"><ParticipantList /></div>
      </section>
    </div>
  );
}
